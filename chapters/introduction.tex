...
\todowrt{Captialization in section titles}
\todowrt{rewrite title}
...
\todocit[inline]{From PB: some more citations are appropriate here. e.g. when you say
	that the research has intensified. maybe find some review article? RVL has
	one thats called "controlling of phonons at the wavelength scale" i think.
maybe you can find some valuable refs there}
...
\tododec{PB:is what you are using here really bulk acoustic waves? 
maybe also mention that you are looking at GHz silicon phonons since they are
interesting in quantum acoustics.}
