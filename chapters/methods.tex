...
beamsplitter. In this section I describe how that was accomplished. First I
specify the skeleton of the device, i.e.\ the parts that were fixed, as well as
the objective function. I then go on to specify how the simulations and
...
Because I am not interested in the phase of the output waves,
...
Ultimately, the device should consist of regions of material and regions of
no material.
