...
fine meshes carried a prohibitively large computational cost.
...
\begin{figure}[htpb]
	...
	\begin{tikzpicture}[domain=1:8]
		...
		\draw[ForestGreen] (1.1, 0.3) pic {reflection};
