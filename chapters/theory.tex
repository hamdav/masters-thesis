...
x)$ with eigenvalues $\exp(i k a)$, where $a = \abs{\vec{a}}$.
...
\todocit[inline]{%
	...
	I don't think Auld does anything with periodic crystals/bloch states?
}
...
over the unit cell.
These are called \emph{floquet periodic boundary conditions} in COMSOL.
...
\todocit[inline]{Citation needed for this section}
...
Here $A v = b$ is replaced by the acoustic field equation:
...
Analogously to the general derivation, the chain rule is used to expand
